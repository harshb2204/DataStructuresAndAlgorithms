...
int main()
{
    ...
    Airport airport1 = {"123", "Airport 1"};
    Airport airport2 = {"456", "Airport 2"};
    Airport airport3 = {"789", "Airport 3"};
    Airport airport4 = {"321", "Airport 4"};
...
void dijkstra(Graph *graph, const char *source, const char *destination)
{
    ...
    if (dist[destIndex] == CUSTOM_INT_MAX)
    {
...
void displayRoutes(Graph *graph)
{
    ...
    for (int i = 0; i < graph->numFlights; ++i)
    {
        ...
        printf("%s: %s (%02d:%02d) -> %s (%02d:%02d), Cost: $%d\n", flight.flightNumber,
               flight.departureAirport.code, flight.departureTime.hours, flight.departureTime.minutes,
               flight.arrivalAirport.code, flight.arrivalTime.hours, flight.arrivalTime.minutes,
               flight.cost);
    }
}
